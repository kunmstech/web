...
export default function HeroSection() {
  return (
    <div className="w-full min-h-[calc(100svh-130px)] bg-white">
      <div className="w-full grid md:grid-cols-2 items-center">
        <div className="w-full h-[calc(100svh-100px)] bg-gradient-to-br from-[#002B5B] to-[#010842] relative">
          <Image
            // src="/truck-on-weigh-bridge2.webp"
            src="/truck-on-weigh-bridge.jpg"
        ...
        <div className="flex flex-col max-w-xl gap-6 px-6">
